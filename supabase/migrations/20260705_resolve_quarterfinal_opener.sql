...
-- Preenche o jogo 97 com os vencedores das oitavas 89 e 90.
...
with source_winners as (
  ...
  where m.match_number in (89, 90)
),
resolved_match as (
  select 97::smallint as match_number,
         w89.team as home_team,
         w90.team as away_team,
         w89.flag as home_flag,
         w90.flag as away_flag
  from source_winners w89
  join source_winners w90 on w90.match_number = 90
  where w89.match_number = 89
)
